...
namespace Models.ProfileModels
{
	...
	public class AssessmentProfile : BaseProfile
	{
		public AssessmentProfile()
		{
			...
			OtherInstructionalProgramCategory = new List<TextValueProfile>();
		...
		public List<CredentialAlignmentObjectProfile> TargetCompetencies
		{
			get
			{
				return CredentialAlignmentObjectFrameworkProfile.FlattenAlignmentObjects( AssessesCompetenciesFrameworks.Concat( RequiresCompetenciesFrameworks ).ToList() );
			}
			set
			{
		...
		public List<ConditionProfile> PreparationFrom { get { return ConditionManifestExpanded.DisambiguateConditionProfiles( AssessmentConnections ).PreparationFrom; } }
		public List<ConditionProfile> AdvancedStandingFrom { get { return ConditionManifestExpanded.DisambiguateConditionProfiles( AssessmentConnections ).AdvancedStandingFrom; } }
